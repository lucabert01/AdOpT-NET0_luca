...
result_path = "./dataCaseStudy_Cement/raw_results/oxy_only"
...
for carbon_tax in explored_carbon_tax:
    ...
    for av_el_price in explored_el_price:
        ...
        pyhub[pyhub_carbon_tax][pyhub_el_price] = adopt.ModelHub()
        ...
        pyhub[pyhub_carbon_tax][pyhub_el_price].construct_balances()
        pyhub[pyhub_carbon_tax][pyhub_el_price].solve()
