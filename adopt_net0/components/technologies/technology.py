...
class Technology(ModelComponent):
    ...
    **Constraint declarations**
    ...
    def _define_ccs_costs(self, b_tec, data: dict):
        """
        Defines CCS costs. The unit capex parameter is calculated from Eq. 10 of Weimann et al. 2023
        ...
        discount_rate = set_discount_rate(config, economics)
        timestep_length = data["topology"]['timestep_length']
        fraction_of_year_modelled = data["topology"]["fraction_of_year_modelled"]
        ...
        b_tec.para_unit_capex_annual_ccs = pyo.Param(
            domain=pyo.Reals,
            initialize=annualization_factor * economics.capex_data["unit_capex"]/timestep_length,
            mutable=True,
        )
